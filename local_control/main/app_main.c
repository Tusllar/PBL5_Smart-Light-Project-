...
static void esp_local_ctrl_service_start(void)
{
    ...
    ESP_LOGI(TAG, "Server certificate length: %zu", https_conf.servercert_len);
    ESP_LOGI(TAG, "Private key length: %zu", https_conf.prvtkey_len);
    ESP_LOGI(TAG, "Server certificate start: %p", https_conf.servercert);
    ESP_LOGI(TAG, "Private key start: %p", https_conf.prvtkey_pem);
